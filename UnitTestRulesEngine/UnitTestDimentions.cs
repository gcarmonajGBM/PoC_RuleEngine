...
namespace UnitTestRulesEngine
{
    ...
    public class UnitTestDimentions
    {
        ...
        public void B_WhenEvaluateDimentionList()
        {
            ...
            var beginCompare = DateTime.UtcNow;
            Console.WriteLine(beginCompare.ToString("yyyy-MM-dd HH:mm:ss.ffffff", CultureInfo.InvariantCulture));
            ...
            var endCompare = DateTime.UtcNow;
            Console.WriteLine(endCompare.ToString("yyyy-MM-dd HH:mm:ss.ffffff", CultureInfo.InvariantCulture));

            Console.WriteLine((beginCompare - endCompare));
            // Acert
            Assert.AreEqual(listDimensionToEval.Count(w => w.ParentDimentionId == null), listDimentionEntity.Count());
        }
    }
